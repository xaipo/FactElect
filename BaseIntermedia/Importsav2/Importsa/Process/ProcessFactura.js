...
module.exports = {
    ...
    processFacturaSql: function (factura, facturaActual, cantidad, actual) {
        ...
        if (actual === 0) {
            ...
            var descuento=factura[14].value;
            if(descuento!=null){
                descuento=descuento/100;
                descuento=facturaActual.informacion.total_sin_impuestos*descuento;
            }else{
                    descuento=0;
            }
            facturaActual.informacion.total_descuento=descuento;
        } else {

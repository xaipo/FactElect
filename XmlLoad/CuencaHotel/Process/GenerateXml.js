...
//parte de impuestos
        ...
        for (var i = 0; i < n; i++) {
            ...
            factura.total_con_impuestos.value[i].base_imponible.value = validation.fixedDecimal(factura.total_con_impuestos.value[i].base_imponible.value);
        ...
        factura.importe_total.value = validation.fixedDecimal(factura.importe_total.value);
        xml.next()

...
module.exports = {
    ...
    readPropina: function () {
        var ret = undefined;
        fs.readFile('PorcentajePropina', function (err, data) {
    ...
    writePropina: function (text,callback) {
        var done = false;
        fs.writeFile('PorcentajePropina', text,function (err) {

    ...
    processFacturaAccess: function (factura, facturaActual, actual) {
        ...
        if (actual == 0) {
            ...
            if(factura.itemDescuentoValor!=null){
                facturaActual.descuento.value=parseFloat(factura.itemDescuentoValor)+parseFloat(facturaActual.descuento.value);
            }
            var impuesto= new Impuesto();
            impuesto.base_imponible.value = factura.subtotal;
            impuesto.valor.value=factura.cantidadImpuesto;
            impuesto.tarifa.value = porcentaje.doce;
            facturaActual.total_con_impuestos.value.push(impuesto);
